...
const LoginRegister = ( { setScreenNoNavbar, setProgram, setFailed } ) => {
    ...
    return (
        <div className={ classes.root }>
            <div className={ classes.container }>
                ...
                { loginOrRegister ?
                    <Login setProgram={ ( value ) => setProgram( value ) }
                           setFailed={ ( value ) => setFailed( value ) }/>
                    :
                    <Register setFailed={ ( value ) => setFailed( value ) }/> }
                <div style={ { marginTop: "20px" } }>
                    <Button variant="text" color="inherit" onClick={ () => setScreenNoNavbar( "about" ) }>About
                        Bilboard</Button>
                </div>
            </div>
        </div>
