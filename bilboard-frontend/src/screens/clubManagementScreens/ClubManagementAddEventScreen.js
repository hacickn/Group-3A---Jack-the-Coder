import { FormControlLabel, Grid, IconButton, Radio, RadioGroup, TextField } from "@mui/material";
...
const useStyles = makeStyles( {
    textGrid: {
        display: "flex", justifyContent: "end", paddingRight: "20px", fontFamily: Constants.OXYGEN_FONT_FAMILY,
            ...
            <Grid container>
                ...
                <Grid container>
                    ...
                    <Grid container className={ classes.rowGrid }>
                        ...
                        <Grid item xs={ 7 } className={ classes.inputGrid }>
                            <Grid container>
                                <RadioGroup row aria-label="type"
                                    ...
                                    <FormControlLabel value="faceToFace" control={ <Radio/> } label="Face to Face"/>
                        ...
                        <Grid item xs={ 7 } className={ classes.inputGrid }>
                            { isOnline === "online" ?
                                <BilboardTextField width={ "500px" } label={ "Enter Zoom Link" }/> :
                    ...
                    <Grid container className={ classes.rowGrid }>
                        ...
                        <Grid item xs={ 7 } className={ classes.inputGrid }>
                            <Radio checked={ isForMember } onClick={ () => setIsForMember( !isForMember ) }/>
                        </Grid>
                    </Grid>
                    <Grid container style={ { display: "flex", justifyContent: "center", paddingTop: "20px", } }>
